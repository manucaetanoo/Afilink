          ...
          <div className="grid gap-10 bg-[radial-gradient(circle_at_top_left,rgba(251,146,60,0.18),transparent_28%),radial-gradient(circle_at_top_right,rgba(255,237,213,0.9),transparent_30%)] px-8 py-10 lg:grid-cols-[1.3fr_0.7fr] lg:px-12 lg:py-14">
            <div>
              ...
              <p className="max-w-2xl text-lg leading-8 text-slate-600">
                Un espacio dentro de Marketafil para que afiliados descubran,
                entiendan y promocionen los productos de la marca. No es una
                tienda clásica: es una base comercial para vender mejor.
              </p>
            ...
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-semibold text-slate-900">
                  Por qué vender productos de {storeSlug}
                </h2>
              </div>
          ...
          <div className="mb-6 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-slate-500">
                Acá no mostramos solo productos. Mostramos oportunidades concretas
                para promocionar la marca y generar ingresos.
              </p>
            </div>
          </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                      ...
                      <div className="grid gap-4 rounded-[24px] border border-orange-100 bg-[#fffaf7] p-5">
                        ...
                        <Link
                          ...
                          className="mt-2 inline-flex items-center justify-center rounded-2xl bg-orange-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-orange-600"
                          >
          ...
          <div className="space-y-8">
            <div className="rounded-[28px] border border-orange-200 bg-gradient-to-br from-orange-50 via-white to-amber-50 p-8 text-slate-900 shadow-[0_20px_50px_rgba(251,146,60,0.12)]">
              ...
              <h2 className="mt-2 text-3xl font-semibold leading-tight text-slate-900">
                Únete al programa y empieza a promocionar {sellerName}
              </h2>
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <button className="rounded-2xl bg-orange-500 px-6 py-3 text-sm font-medium text-white transition hover:bg-orange-600">
                  Quiero promocionar esta marca
                </button>
                <button className="rounded-2xl border border-orange-200 bg-white px-6 py-3 text-sm font-medium text-slate-900 transition hover:bg-orange-50">
                  Contactar empresa
                </button>
