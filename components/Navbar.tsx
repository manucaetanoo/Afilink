...
const userName = user?.storeSlug || "Usuario";
const userEmail = user?.email || "";
  ...
  const activeClasses =
    "inline-flex items-center border-b-2 border-orange-600 px-1 pt-1 text-sm font-medium text-gray-900 dark:border-indigo-500 dark:text-white"
  ...
  return (
<Disclosure as="nav" className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm dark:bg-gray-800/50 dark:shadow-none">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 justify-between">
          <div className="flex">
            <div className="flex shrink-0 items-center">
              <img alt="Your Company" src="/img/logosbg.png" className="h-8 w-auto dark:hidden" />
              <img alt="Your Company" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" className="h-8 w-auto not-dark:hidden" />
            </div>
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <Menu as="div" className="relative ml-3">
              <MenuButton className="relative flex rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600 dark:focus-visible:outline-indigo-500">
                <span className="absolute -inset-1.5" />
              ...
              <MenuItems
                ...
                <MenuItem>
                 <LogoutButton />
                    ...
                    <a href="/login" className='block px-4 py-2 text-sm text-gray-800 data-focus:bg-gray-100 data-focus:outline-hidden dark:text-gray-300 dark:data-focus:bg-white/5'>
                        Log in ➝
                        </a>
                )}
          </div>
